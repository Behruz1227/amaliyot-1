...
function MockUp13() {
  ...
  return (
    <div className='ps-5 row mokUp13-main pt-4 w-100'>
      <div className="col-9 mt-5">
        <Sidebar />
        <h4 className='float-start ms-5'>Операции<span class="badge text-black bg-light">21</span></h4>
        ...
        <div className="mokUp13-body ms-5">
          <div className="w-100 row">
            <h5 className="col">Дата</h5>
            <h5 className="col-3">Тип</h5>
            <h5 className="col-2">Уровен</h5>
            <h5 className="col-2">Кассир</h5>
            <h5 className="col">Баллы</h5>
            <h5 className="col-3 text-end">UZS
              <svg className='ms-4' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <div className="col-3 d-flex justify-content-center">
        <div className="mokUp-col-2 mt-5">
